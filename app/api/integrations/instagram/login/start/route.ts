...
export async function GET(request: Request) {
    ...
    const scope = "instagram_basic,instagram_manage_messages,instagram_manage_comments,pages_manage_metadata,pages_show_list,pages_read_engagement,business_management,pages_messaging";
