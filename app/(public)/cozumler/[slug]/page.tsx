...
const SECTORS: Record<string, {
    ...
    "tekne-yat-kiralama": {
        name: "Tekne & Yat Kiralama", emoji: "⛵",
        title: "Tekne ve Yat Kiralama İşletmeleri İçin WhatsApp & Instagram Yönetimi",
        description: "Tekne ve yat kiralama işletmenizin müşteri iletişimini yapay zeka ile yönetin. Rezervasyon otomasyonu, rota önerileri ve 7/24 AI asistan.",
        metaDesc: "Tekne ve yat kiralama için WhatsApp yapay zeka asistanı. Rezervasyon otomasyonu, fiyat bilgilendirme, Instagram DM yönetimi. 7 gün ücretsiz deneyin.",
        heroText: "Müşterileriniz Instagram'da yat fotoğraflarınızı görüyor, WhatsApp'tan fiyat ve müsaitlik soruyor. Sezon yoğunluğunda hiçbir talebi kaçırmayın — AI asistanınız 7/24 profesyonel hizmet versin.",
        problems: [
            "Instagram'daki tekne fotoğraflarına gelen DM'lere geç yanıt — müşteri rakibe gidiyor",
            "Sezon yoğunluğunda yüzlerce fiyat ve müsaitlik sorusuna yetişilemiyor",
            "Farklı tekneler için farklı fiyatlar, kapasite bilgileri karışıyor",
            "Yabancı turistlerle dil bariyeri — İngilizce, Rusça, Almanca mesajlara yanıt verilemiyor",
            "Rezervasyon onayları, depozito takibi ve iptal süreçleri manuel yürütülüyor",
            "Rota, hava durumu ve ekipman soruları tekrar tekrar cevaplanıyor",
        ],
        solutions: [
            { title: "AI Rezervasyon Asistanı", desc: "Müşteri tarih ve kişi sayısı yazsın, AI uygun tekneleri, fiyatları ve müsait tarihleri anında sunsun. Onay alıp takvime otomatik eklesin.", icon: "calendar" },
            { title: "Çok Dilli Destek", desc: "İngilizce, Rusça, Almanca, Arapça — 40+ dilde otomatik çeviri. Yabancı turistlerle ana dillerinde iletişim kurun.", icon: "message" },
            { title: "Filo Bilgilendirme", desc: "Her tekne/yatın kapasitesi, donanımı, fiyatı, fotoğrafları — AI müşterinin ihtiyacına göre en uygun seçeneği önerir.", icon: "bot" },
            { title: "Rota & Hizmet Rehberi", desc: "Popüler rotalar, dahil olan hizmetler, ekstra ekipman bilgileri — AI sık sorulan tüm soruları profesyonelce yanıtlar.", icon: "users" },
        ],
        features: [
            "WhatsApp ve Instagram tek panelde",
            "Tekne/yat bazlı müsaitlik takvimi entegrasyonu",
            "40+ dilde otomatik çeviri — turist müşteriler",
            "Filo kataloğu — kapasite, fiyat, donanım bilgileri",
            "Depozito ve ödeme hatırlatmaları",
            "Rota önerileri ve hava durumu bilgilendirmesi",
            "Sezon öncesi kampanya mesajları",
            "Müşteri kartları — tercihler, geçmiş kiralamalar",
            "Instagram DM otomasyonu — fotoğraf ve fiyat paylaşımı",
            "7/24 AI asistan — mesai dışı ve gece talepleri",
        ],
        cta: "Tekne ve yat kiralama işletmenizin dijital iletişimini dönüştürmeye hazır mısınız?",
        scenario: "Temmuz ayı, sezon tam gaz. Instagram'da paylaştığınız Göcek rota videosuna 2 saatte 25 DM geldi: 'How much for a day trip?', 'Сколько стоит на неделю?' (Rusça: Haftalık fiyat ne kadar?), 'Kaç kişilik tekneleriniz var?', 'Bu cumartesi müsait mi?'. Telefonunuz susmak bilmiyor, WhatsApp'ta da 15 mesaj birikmiş — fiyat soruları, rota bilgisi isteyenler, depozito soran müşteriler.\n\nBir yandan limanda tekne hazırlığı yapıyorsunuz, bir yandan kaptanlarla koordine oluyorsunuz. Mesajlara bakacak vakit yok. Akşam baktığınızda 3 müşteri çoktan başka firmadan rezervasyon yapmış.\n\nUppyPro devredeyken: AI asistanınız İngilizce yazan müşteriye İngilizce, Rusça yazan müşteriye Rusça otomatik yanıt verdi. Tarih ve kişi sayısını sordu, uygun tekneleri fiyatlarıyla birlikte sundu. 8 müşteri aynı gün rezervasyon onayı verdi. Rota soruları hazır bilgilerden yanıtlandı, depozito hatırlatmaları otomatik gönderildi.\n\nSiz limandan döndüğünüzde paneli açtınız: 12 yeni rezervasyon, 0 cevapsız mesaj, 3 farklı dilde profesyonel iletişim. Ve yeni sezon kampanyanız için geçen yıl kiralama yapan 150 müşteriye toplu WhatsApp bildirimi göndermeye hazısınız.",
        stats: [
            { value: "%80", label: "Daha Hızlı Yanıt", desc: "Sezon yoğunluğunda bile anlık yanıt" },
            { value: "40+", label: "Dil Desteği", desc: "Turistlerle ana dillerinde iletişim" },
            { value: "3x", label: "Daha Fazla Rezervasyon", desc: "Kaçırılan DM'ler sıfıra yaklaşır" },
            { value: "7/24", label: "Kesintisiz Hizmet", desc: "Gece gelen taleplere bile anında yanıt" },
        ],
        beforeAfter: [
            { before: "Instagram DM'lerine saatler sonra dönüyorsunuz, müşteri başka firmaya gitmiş", after: "AI saniyeler içinde fiyat, kapasite ve müsaitlik bilgisi paylaşıyor" },
            { before: "Yabancı turistlere Google Translate ile zorlu iletişim", after: "40+ dilde otomatik çeviri, profesyonel diyalog" },
            { before: "Her tekne için fiyat, kapasite bilgisi ayrı ayrı yazılıyor", after: "AI filo kataloğundan müşteriye uygun seçenekleri otomatik sunuyor" },
            { before: "Depozito ve ödeme takibi excel'de, bazen unutuluyor", after: "Otomatik depozito hatırlatma, ödeme onayı takibi" },
            { before: "Sezon kampanyaları elle tek tek gönderiliyor", after: "Geçmiş müşterilere toplu WhatsApp kampanya bildirimi" },
        ],
    },
    "villa-apart-kiralama": {
        name: "Villa & Apart Kiralama", emoji: "🏡",
        title: "Villa ve Apart Kiralama İşletmeleri İçin WhatsApp & Instagram Yönetimi",
        description: "Villa ve apart kiralama işletmenizin müşteri iletişimini yapay zeka ile yönetin. Rezervasyon otomasyonu, tesis bilgilendirme ve 7/24 AI asistan.",
        metaDesc: "Villa ve apart kiralama için WhatsApp yapay zeka asistanı. Rezervasyon otomasyonu, fiyat bilgilendirme, Instagram DM yönetimi. 7 gün ücretsiz deneyin.",
        heroText: "Misafirleriniz Instagram'da villa fotoğraflarınızı görüyor, WhatsApp'tan fiyat ve müsaitlik soruyor. Yaz sezonunda her talepe anında dönüş yapın — AI asistanınız 7/24 profesyonel hizmet versin.",
        problems: [
            "Instagram'daki villa/apart fotoğraflarına gelen DM'lere geç yanıt — misafir kaybı",
            "Sezon yoğunluğunda onlarca fiyat ve müsaitlik sorusuna yetişilemiyor",
            "Farklı üniteler için farklı fiyatlar, dönemsel tarifeler karışıyor",
            "Check-in/check-out bilgileri, ev kuralları ve konum tarifi tekrar tekrar gönderiliyor",
            "Yabancı misafirlerle dil bariyeri — çok dilde iletişim gerekiyor",
            "Rezervasyon onayları, kapora takibi ve iptal süreçleri manuel yönetiliyor",
        ],
        solutions: [
            { title: "AI Rezervasyon Asistanı", desc: "Misafir tarih, kişi sayısı ve tercihlerini yazsın, AI uygun villa/apart seçeneklerini, dönemsel fiyatları ve müsait tarihleri anında sunsun.", icon: "calendar" },
            { title: "Tesis Bilgilendirme", desc: "Her villa/apart'ın oda sayısı, kapasitesi, havuz bilgisi, konumu, fotoğrafları — AI misafirin ihtiyacına göre en uygun seçeneği önerir.", icon: "bot" },
            { title: "Çok Dilli Destek", desc: "İngilizce, Almanca, Rusça, Arapça — 40+ dilde otomatik çeviri. Yabancı misafirlerle kendi dillerinde rahat iletişim.", icon: "message" },
            { title: "Misafir Rehberi", desc: "Check-in talimatları, ev kuralları, WiFi şifresi, çevre rehberi, restoran önerileri — AI tüm bilgileri otomatik paylaşır.", icon: "users" },
        ],
        features: [
            "WhatsApp ve Instagram tek panelde",
            "Villa/apart bazlı müsaitlik takvimi",
            "Dönemsel fiyat yönetimi — erken sezon, yüksek sezon, bayram",
            "40+ dilde otomatik çeviri — turistler için",
            "Tesis kataloğu — oda sayısı, kapasite, özellikler, fotoğraflar",
            "Otomatik check-in bilgilendirmesi — konum, şifre, kurallar",
            "Kapora ve ödeme hatırlatmaları",
            "Çevre rehberi — plajlar, marketler, restoranlar",
            "Misafir kartları — tercihler, geçmiş konaklamalar",
            "Memnuniyet anketi — konaklama sonrası otomatik geri bildirim",
            "Instagram DM otomasyonu — fotoğraf ve fiyat paylaşımı",
            "7/24 AI asistan — gece gelen taleplere anında yanıt",
        ],
        cta: "Villa ve apart kiralama işletmenizin dijital iletişimini dönüştürmeye hazır mısınız?",
        scenario: "Haziran başı. Booking ve Instagram reklamlarınız çalışıyor, günde 40-50 mesaj geliyor. WhatsApp'ta: 'Temmuz 15-22 arası 4+1 villanız müsait mi?', 'Havuzlu apart var mı?', 'Check-in saati kaç?', 'Fiyata kahvaltı dahil mi?'. Instagram DM'de villa fotoğraflarınıza 20 yorum ve mesaj birikmiş: 'Price?', 'Wie viel kostet es pro Nacht?' (Almanca: Gecelik fiyat ne kadar?).\n\nSiz bir yandan misafir karşılıyorsunuz, bir yandan temizlik ekibini koordine ediyorsunuz, bir yandan da çıkış yapan misafirlerin depozitosunu iade ediyorsunuz. Mesajlara bakacak zamanınız yok.\n\nUppyPro kurulu olsaydı: AI asistanınız her mesajı anında yanıtlardı. Temmuz tarihleri için müsait villa/apartları dönemsel fiyatlarıyla birlikte sunardı. Havuzlu apart isteyen misafire filtrelenmiş seçenekleri gösterirdi. Almanca yazan misafire Almanca, İngilizce yazan misafire İngilizce yanıt verirdi.\n\nRezervasyon onaylayan misafire otomatik kapora hatırlatması gönderilirdi. Check-in tarihinden 1 gün önce konum, giriş şifresi, WiFi bilgisi ve ev kuralları otomatik iletilirdi. Check-out sonrası memnuniyet anketi gönderilirdi.\n\nAkşam paneli açtığınızda: 8 yeni rezervasyon onaylanmış, 5 farklı dilde iletişim sağlanmış, 0 cevapsız mesaj. Ve geçen yıl konaklayan 200 misafire erken rezervasyon kampanyanızı toplu göndermek için tek tıkla hazırsınız.",
        stats: [
            { value: "%75", label: "Daha Hızlı Yanıt", desc: "Sezon yoğunluğunda bile anlık yanıt" },
            { value: "40+", label: "Dil Desteği", desc: "Yabancı misafirlerle ana dillerinde iletişim" },
            { value: "2x", label: "Daha Fazla Rezervasyon", desc: "Cevapsız mesaj sıfıra yaklaşır" },
            { value: "7/24", label: "Kesintisiz Hizmet", desc: "Gece ve hafta sonu dahil her an aktif" },
        ],
        beforeAfter: [
            { before: "Instagram DM'lerine saatler sonra dönüyorsunuz, misafir alternatif bulmuş", after: "AI saniyeler içinde fiyat, müsaitlik ve tesis bilgisi paylaşıyor" },
            { before: "Yabancı misafirlere Google Translate ile zorlu iletişim", after: "40+ dilde otomatik çeviri, doğal ve profesyonel diyalog" },
            { before: "Check-in bilgileri, konum ve kurallar elle tek tek gönderiliyor", after: "AI check-in öncesi otomatik bilgilendirme — şifre, konum, kurallar" },
            { before: "Dönemsel fiyat tablosu karışıyor, yanlış fiyat verilme riski", after: "AI dönemsel fiyatları otomatik hesaplayıp sunar" },
            { before: "Kapora takibi ve ödeme hatırlatmaları unutuluyor", after: "Otomatik kapora hatırlatma ve ödeme onayı takibi" },
            { before: "Misafir memnuniyeti ölçülemiyor", after: "Check-out sonrası otomatik anket, geri bildirim toplama" },
        ],
    },
    "studyo-kiralama": {
        name: "Stüdyo Kiralama", emoji: "🎤",
        title: "Stüdyo Kiralama İşletmeleri İçin WhatsApp & Instagram Yönetimi",
        description: "Müzik, fotoğraf, video ve film stüdyonuzun müşteri iletişimini yapay zeka ile yönetin. Seans rezervasyonu, ekipman bilgilendirme ve 7/24 AI asistan.",
        metaDesc: "Stüdyo kiralama için WhatsApp yapay zeka asistanı. Seans rezervasyonu, ekipman bilgilendirme, fiyat paylaşımı, Instagram DM yönetimi. 7 gün ücretsiz deneyin.",
        heroText: "Müşterileriniz Instagram'da stüdyo fotoğraflarınızı görüyor, WhatsApp'tan fiyat, ekipman ve müsaitlik soruyor. Prodüksiyon koşturmacasında hiçbir talebi kaçırmayın — AI asistanınız 7/24 profesyonel hizmet versin.",
        problems: [
            "Çekim veya kayıt sırasında WhatsApp'a bakılamıyor — potansiyel müşteri kaybı",
            "Her seferinde aynı ekipman listesi, fiyat ve stüdyo özelliklerini tekrar tekrar yazma",
            "Saat bazlı rezervasyonlarda çakışma ve çifte kiralama riski",
            "Farklı stüdyo tipleri (müzik, foto, video, film) için farklı fiyat ve donanım bilgisi karışıyor",
            "Instagram DM'lerinden gelen stüdyo fotoğrafı ve fiyat taleplerine geç yanıt",
            "Ek hizmetler (ses mühendisi, ışıkçı, makyöz) ve ekipman kiralamalarının koordinasyonu",
        ],
        solutions: [
            { title: "AI Seans Asistanı", desc: "Müşteri tarih, saat ve stüdyo tipini yazsın, AI müsait stüdyoları ve saatleri fiyatlarıyla birlikte anında sunsun. Onay alıp takvime otomatik eklesin.", icon: "calendar" },
            { title: "Ekipman & Hizmet Bilgilendirme", desc: "Her stüdyoda sağlanan ekipmanlar (mikrofon, kamera, ışık seti, green screen), ek hizmetler ve fiyatları — AI müşterinin ihtiyacına göre detaylı liste sunar.", icon: "bot" },
            { title: "Stüdyo Kataloğu", desc: "Müzik kayıt, fotoğraf, video prodüksiyon, film seti — her stüdyonun fotoğrafları, alan bilgisi ve kapasitesi AI tarafından anında paylaşılır.", icon: "message" },
            { title: "Ek Hizmet Koordinasyonu", desc: "Ses mühendisi, ışıkçı, makyöz, catering gibi ek hizmetlerin müsaitliğini AI kontrol eder ve seansa otomatik ekler.", icon: "users" },
        ],
        features: [
            "WhatsApp ve Instagram tek panelde",
            "Saat bazlı stüdyo müsaitlik takvimi",
            "Stüdyo tipi bazlı fiyatlandırma (saatlik, günlük, paket)",
            "Ekipman ve donanım listesi paylaşımı",
            "Ek hizmet (ses mühendisi, ışıkçı vb.) yönetimi",
            "Stüdyo fotoğraflarının otomatik gönderimi",
            "40+ dilde otomatik çeviri — yabancı prodüksiyonlar",
            "Müşteri kartları — tercihler, geçmiş seanslar",
            "Instagram DM otomasyonu — stüdyo tanıtımı ve fiyat paylaşımı",
            "Kapora ve ödeme hatırlatmaları",
            "7/24 AI asistan — gece ve hafta sonu talepleri",
        ],
        cta: "Stüdyonuzun dijital iletişimini yapay zeka ile dönüştürmeye hazır mısınız?",
        scenario: "Cumartesi günü. Stüdyo A'da bir müzik kaydı devam ediyor, Stüdyo B'de fotoğraf çekimi var. Ses mühendisi mikser başında, siz de prodüksiyonla ilgileniyorsunuz. Bu sırada WhatsApp'ta 12 mesaj birikmiş: 'Yarın akşam 2 saatlik müzik kaydı için stüdyo müsait mi?', 'Green screen'li video alanınız var mı? Fiyatı nedir?', 'Podcast çekimi için ekipman listenizi alabilir miyim?', 'Saatlik kiralama fiyatları ne?'\n\nInstagram DM'de stüdyo fotoğraflarınıza 8 mesaj gelmiş: 'Bu stüdyo harika! Fotoğraf çekimi için müsait misiniz?', 'Fiyatları öğrenebilir miyim?'. Kayıt ortasında telefona bakmak imkansız. Akşam baktığınızda 4 müşteri çoktan başka bir stüdyo bulmuş.\n\nUppyPro devredeyken: AI asistanınız her mesajı anında yanıtladı. Yarın akşam müsait stüdyoları saatleriyle birlikte sundu, onay alıp takvime ekledi. Green screen sorusuna video stüdyosunun fotoğraflarını, ekipman listesini ve fiyatını paylaştı. Podcast için gerekli donanımı listeleyip uygun saatleri sundu.\n\nInstagram'daki fotoğraf çekimi taleplerine anında müsaitlik bilgisi ve stüdyo detayları paylaşıldı. Akşam paneli açtığınızda: 6 yeni seans rezervasyonu, 0 cevapsız mesaj, 3 stüdyo tipi için koordineli planlama. Ve gelecek ay için toplu WhatsApp kampanyanıza hazırsınız — geçen ay kayıt yapan 80 müşteriye 'Gece seansı %20 indirimli' bildirimi göndermek tek tıkla mümkün.",
        stats: [
            { value: "%75", label: "Daha Hızlı Yanıt", desc: "Prodüksiyon yoğunluğunda bile anlık yanıt" },
            { value: "3x", label: "Daha Fazla Seans", desc: "Kaçırılan talepler sıfıra yaklaşır" },
            { value: "0", label: "Çifte Kiralama", desc: "AI takvim kontrolü ile çakışma imkansız" },
            { value: "7/24", label: "Kesintisiz Hizmet", desc: "Gece ve hafta sonu dahil her an aktif" },
        ],
        beforeAfter: [
            { before: "Kayıt/çekim sırasında WhatsApp'a bakılamıyor, müşteri başka stüdyoya gidiyor", after: "AI saniyeler içinde müsaitlik, fiyat ve ekipman bilgisi paylaşıyor" },
            { before: "Her müşteriye aynı ekipman listesini ve fiyatları tekrar tekrar yazıyorsunuz", after: "AI stüdyo tipine göre ekipman, donanım ve fiyat listesini otomatik sunuyor" },
            { before: "Saat bazlı rezervasyonlarda çakışma oluyor, iki müşteriye aynı saat verilmiş", after: "AI takvim kontrolü ile çifte kiralama imkansız, stüdyolar koordineli" },
            { before: "Ek hizmetler (ses mühendisi, ışıkçı) elle koordine ediliyor, bazen unutuluyor", after: "AI ek hizmet müsaitliğini kontrol edip seansa otomatik ekliyor" },
            { before: "Instagram DM'lerine geç dönüş, özellikle fotoğraf çekimi talepleri kaçıyor", after: "AI stüdyo fotoğraflarını ve fiyat bilgisini anında paylaşıyor" },
