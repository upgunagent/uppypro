...
import { Link, CreditCard, User, Plug } from "lucide-react";
...
export function AdminSettingsTabs({ connectionTab, profileTab, subscriptionTab }: AdminSettingsTabsProps) {
    return (
...
export function AdminConnectionTabs({ channelsContent, aiContent }: { channelsContent: ReactNode, aiContent: ReactNode }) {
    return (
